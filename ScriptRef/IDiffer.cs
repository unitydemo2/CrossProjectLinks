...
namespace DiffPlex
{
    /// <summary>
                ...
                /// </summary>
                /// <description>
                /// <br/>  class AddNumbers<br/>  {<br/>     public static void main(String args[])<br/>     {<br/>        int x, y, z;<br/>   <br/>        System.out.println("Enter two integers to calculate their sum");<br/>        Scanner in = new Scanner(System.in);<br/>       <br/>        x = in.nextInt();<br/>        y = in.nextInt();<br/>        z = x + y;<br/>       <br/>        System.out.println("Sum of the integers "z);<br/>     }<br/>  }<br/>
                /// </description>
